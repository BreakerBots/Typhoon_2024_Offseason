...
public class IntakeForShooter extends SequentialCommandGroup {
  ...
  public IntakeForShooter(Intake2 intake, Hopper hopper, ZED zed, /* NoteVision nv,*/ Shooter shooter) {
    ...
    addCommands(
      ...
      intake.smartRollerControlCommand(zed,/* nv,*/IntakeSetpoint.EXTENDED_NEUTRAL, hopper::hasNote)
